...
import "./NetworkingSecurity.css";

function NetworkingSecurity() {
  const { t } = useTranslation();
  return (
    <div>
      <TopBackground title="Networking Security" text="Our partners are the best!" />
      <Fade bottom>
        <div className="about-section">
          <FixedLogo className="fixed-logo" />
          <div className="container">
            <h2 className="title">{t("Networking Security")}</h2>
