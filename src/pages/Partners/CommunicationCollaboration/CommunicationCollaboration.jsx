...
import "./CommunicationCollaboration.css";

function CommunicationCollaboration() {
  const { t } = useTranslation();
  return (
    <div>
      <TopBackground title="Communication Collaboration" text="Our partners are the best!" />
      <Fade bottom>
        <div className="about-section">
          <FixedLogo className="fixed-logo" />
          <div className="container">
            <h2 className="title">{t("Communication Collaboration")}</h2>
